...
export default function Forum() {
  ...
  return (
    <main className="min-h-screen bg-[#F3F0E8] text-[#171614]">
      ...
      <footer className="border-t border-[#171614]/15 px-6 py-7 lg:px-12"><div className="mx-auto flex max-w-[1440px] justify-between font-sans text-[10px] uppercase tracking-[0.13em] text-[#171614]/50"><span>© Thinkoria / Forum</span><a href="/">Return home</a></div></footer>
