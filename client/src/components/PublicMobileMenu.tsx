...
export default function PublicMobileMenu({ links, cta, account }: PublicMobileMenuProps) {
  ...
  return (
    <div className="md:hidden">
      ...
      {open && (
        <div id="public-mobile-menu" className="absolute inset-x-0 top-full z-40 border-t border-current/15 bg-[var(--thinkoria-surface)] px-6 py-5 font-sans text-xs uppercase tracking-[0.14em] shadow-lg">
